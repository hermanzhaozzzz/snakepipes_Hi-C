...
# 2022-07-27
mergestat <- list.files(path=hicDir, pattern=paste0(sampleName, ".rm_dup_pairs.allValidPairs.mergestat"), full.names=TRUE)
...
allvalidpairs <- list.files(path=hicDir, pattern=paste0(sampleName, ".merged_sortn.bwt2pairs.sorted.validPairs"), full.names=TRUE)
